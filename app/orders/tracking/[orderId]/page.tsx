...
// Remove static mock; fetch from API
...
async function openMessageThread(target: 'seller' | 'vidyut') {
  // Lightweight client-side message modal implemented with a new window to /messages style route (optional)
  // For now, fallback to WhatsApp prefill for immediate UX
  try {
    const url = `https://wa.me/?text=${encodeURIComponent('Hi, I need help with my order.')}`
